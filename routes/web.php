...
Route::get('/service/destroy/{service}', [ServiceController::class,'destroy'])->name('service.destroy');
...
Route::get('/prestataire/edit/{prestataire}', [PrestataireController::class,'edit'])->name('prestataire.edit');
Route::put('/prestataire/update/{prestataire}', [PrestataireController::class,'update'])->name('prestataire.update');
Route::post('/prestataire/update{prestataire}', [PrestataireController::class,'update']);
Route::get('/prestataire/destroy/{prestataire}', [PrestataireController::class,'destroy'])->name('prestataire.destroy');
...
Route::get('/organisateur/edit/{organisateur}', [OrganisateurController::class,'edit'])->name('organisateur.edit');
Route::put('/organisateur/update/{organisateur}', [OrganisateurController::class,'update'])->name('organisateur.update');
Route::post('/organisateur/update{organisateur}', [OrganisateurController::class,'update']);
Route::get('/organisateur/destroy/{organisateur}', [OrganisateurController::class,'destroy'])->name('organisateur.destroy');
...
Route::get('/lieu/edit/{lieu}', [LieuController::class,'edit'])->name('lieu.edit');
Route::put('/lieu/update/{lieu}', [LieuController::class,'update'])->name('lieu.update');
Route::get('/lieu/update{lieu}', [LieuController::class,'update']);
Route::delete('/lieu/destroy/{lieu}', [LieuController::class,'destroy'])->name('lieu.destroy');
...
Route::get('/reclamation/edit/{reclamation}', [ReclamationController::class,'edit'])->name('reclamation.edit');
Route::put('/reclamation/update/{reclamation}', [ReclamationController::class,'update'])->name('reclamation.update');
Route::get('/reclamation/update{reclamation}', [ReclamationController::class,'update']);
Route::get('/reclamation/destroy/{reclamation}', [ReclamationController::class,'destroy'])->name('reclamation.destroy');
...
Route::get('type/edit/{typeevenement}', [TypeEvenementController::class,'edit'])->name('type.edit');
Route::put('type/update/{typeevenement}', [TypeEvenementController::class,'update'])->name('type.update');
Route::post('type/update{typeevenement}', [TypeEvenementController::class,'update']);
Route::get('type/destroy/{typeevenement}', [TypeEvenementController::class,'destroy'])->name('type.destroy');
