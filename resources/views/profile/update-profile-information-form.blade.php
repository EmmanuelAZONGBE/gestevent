<x-form-section submit="updateProfileInformation">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $this->user->picture }}" alt="{{ $this->user->last_name }} {{ $this->user->name }}" class="rounded-full h-20 w-20 object-cover">
                </div>
    ...
    <x-slot name="actions">
        ...
        <x-button wire:loading.attr="disabled" wire:target="picture">
            {{ __('Save') }}
        </x-button>
    </x-slot>
</x-form-section>
