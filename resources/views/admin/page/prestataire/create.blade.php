...
@section('content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a >Listes des prestataires</a></li>
                <li class="breadcrumb-item active">créer un prestataire</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="d-flex align-items-center justify-content-end">
            <div class="col-lg-9 mx-lg-auto">
                <div class="card d-flex align-items-center justify-content-center ">
                    <div class="card-body">
                        <h5 class="card-title"> Ajouter un prestataire </h5>
                        ...
                        <form class="row g-3" action="{{ route('prestataire.store') }}" method="POST"
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('societer') ? ' is-invalid' : '' }}"
                                    value="{{ old('societer') }}" type="text" name="societer" id="societer"
                                     required>
                                @if ($errors->has('societer'))
                                    <span class="invalid-feedback" role="alert">
                                        {{ $errors->first('societer') }}
                                    </span>
                                @endif
                            </div>
                            <div class="col-md-12">
